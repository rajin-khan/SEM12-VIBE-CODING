...
def get_waivers(
    program_info: ProgramInfo | None, cli_waivers: str | None = None, interactive: bool = True
) -> set[str]:
...
def compute_adjusted_credits(program_info: ProgramInfo, waivers: set[str]) -> int:
...
def waiver_credit_bonus(
    waivers: set[str],
    program_info: ProgramInfo | None = None,
    transcript_codes: set[str] | None = None,
) -> float:
